...
"set guifont=Anonymice\ Powerline\ Plus\ Nerd\ File\ Types\ Mono\ Plus\ Pomicons
set guifont =Hurmit\ PNFT\ Light:h14
set number
set relativenumber
set history=1000
"set shell=/usr/local/bin/zsh-5.0.8
set shell=$SHELL
set showcmd
set showmode
set rtp+=/usr/local/Cellar/fzf/-1.10.1
